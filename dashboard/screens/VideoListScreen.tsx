  ...
  return (
    <div className="flex flex-col h-full gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <button className="flex items-center gap-2 bg-primary hover:bg-primary/90 text-white px-5 py-2.5 rounded-lg font-medium transition-all shadow-lg shadow-primary/20 active:scale-95">
          <UploadCloud size={20} />
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-center justify-between bg-white dark:bg-[#16212b] p-2 rounded-xl border border-slate-200 dark:border-[#324d67]/30 shadow-sm">
        ...
        <div className="flex gap-2 w-full sm:w-auto">
          <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 py-2.5 bg-slate-50 dark:bg-[#0b1219] hover:bg-slate-100 dark:hover:bg-[#1f2b38] text-slate-600 dark:text-[#92adc9] hover:text-slate-900 dark:hover:text-white rounded-lg transition-colors text-sm font-medium">
            <Filter size={18} />
            Filter
          </button>
          <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 py-2.5 bg-slate-50 dark:bg-[#0b1219] hover:bg-slate-100 dark:hover:bg-[#1f2b38] text-slate-600 dark:text-[#92adc9] hover:text-slate-900 dark:hover:text-white rounded-lg transition-colors text-sm font-medium">
      ...
      <div className="flex-1 w-full overflow-hidden rounded-xl border border-slate-200 dark:border-[#324d67]/30 bg-white dark:bg-[#16212b] flex flex-col shadow-xl">
            ...
            <div key={item.id} className="group grid grid-cols-12 gap-4 border-b border-slate-100 dark:border-[#324d67]/30 px-4 py-3 hover:bg-slate-50 dark:hover:bg-[#1f2b38] transition-colors items-center">
              ...
              <div className="col-span-4 sm:col-span-3 md:col-span-2 flex items-center justify-between sm:justify-start gap-4">
                ...
                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button className="p-1.5 text-slate-400 hover:text-primary hover:bg-primary/10 rounded transition-colors" title="Edit">
                    <Edit2 size={16} />
                  </button>
                  <button className="p-1.5 text-slate-400 hover:text-red-500 hover:bg-red-500/10 rounded transition-colors" title="Delete">
                    <Trash2 size={16} />
                  </button>
                </div>
              </div>
        ...
        <div className="bg-slate-50 dark:bg-[#1f2b38] border-t border-slate-200 dark:border-[#324d67]/30 p-3 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 dark:text-[#92adc9]">
          <div className="flex items-center gap-2">
            ...
            <select className="bg-white dark:bg-[#0b1219] border border-slate-300 dark:border-[#324d67]/30 rounded px-2 py-1 text-slate-900 dark:text-white focus:ring-1 focus:ring-primary focus:border-primary outline-none">
              <option>10</option>
              <option>25</option>
              <option>50</option>
            </select>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-1">
              <button className="p-1 hover:text-slate-900 dark:hover:text-white disabled:opacity-50" disabled>
                <ChevronLeft size={18} />
              </button>
              <button className="p-1 hover:text-slate-900 dark:hover:text-white">
