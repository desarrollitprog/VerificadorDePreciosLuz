      ...
      <div className="p-4">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">IP: {ip}</p>
            </div>
          </div>
        ...
        <div className="mt-4">
          <div className="flex justify-between items-center mb-2">
            <span className="text-xs font-medium text-slate-600 dark:text-slate-400">Almacenamiento</span>
            <span className={`text-xs font-bold ${porcentaje_uso > 90 ? 'text-red-500' : porcentaje_uso > 70 ? 'text-yellow-500' : 'text-emerald-500'}`}>
              {porcentaje_uso}%
            </span>
          </div>
